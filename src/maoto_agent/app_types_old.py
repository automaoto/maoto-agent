...
class ApiKey:
    ...
    def from_dict(data: dict):
        return ApiKey(
            apikey_id=uuid.UUID(str(data["apikey_id"])),
            time=datetime.fromisoformat(str(data["time"])),
            user_id=uuid.UUID(str(data["user_id"])),
            name=data["name"],
            roles=[str(role) for role in data["roles"]] if "roles" in data else [],
            url=str(data["url"]) if "url" in data else None
        )
...
class NewOfferCallable:
    def __init__(self, apikey_id: uuid.UUID, post_id: uuid.UUID, skill_id: uuid.UUID, id_resolver: str, description: str, tags: list[str], parameters: str, cost: float):
        self.apikey_id = apikey_id
    ...
    def __str__(self):
        return f"API Key ID: {self.apikey_id}\nPost ID: {self.post_id}\nSkill ID: {self.skill_id}\nID Resolver: {self.id_resolver}\nDescription: {self.description}\nTags: {self.tags}\nParameters: {self.parameters}\nCost: {self.cost}"
    
    def __repr__(self):
        return f"NewOfferCallable(apikey_id='{self.apikey_id!r}', post_id='{self.post_id!r}', skill_id='{self.skill_id!r}', id_resolver='{self.id_resolver!r}', description='{self.description!r}', tags='{self.tags!r}', parameters='{self.parameters!r}', cost='{self.cost!r}')"
    
class OfferCallable(NewOfferCallable):
    def __init__(self, id: uuid.UUID, time: datetime, apikey_id: uuid.UUID, post_id: uuid.UUID, skill_id: uuid.UUID, id_resolver: str, description: str, tags: list[str], parameters: str, cost: float):
        super().__init__(apikey_id, post_id, skill_id, id_resolver, description, tags, parameters, cost)
        self.id = id
        self.time = time
    ...
    def __repr__(self):
        return f"OfferCallable(id='{self.id!r}', time='{self.time!r}', apikey_id='{self.apikey_id!r}', post_id='{self.post_id!r}', skill_id='{self.skill_id!r}', id_resolver='{self.id_resolver!r}', description='{self.description!r}', tags='{self.tags!r}', parameters='{self.parameters!r}', cost='{self.cost!r}')"

    def get_assistant_info(self):
        return f"OfferCallable(id='{self.id}',description='{self.description!r}',tags='{self.tags!r}',parameters='{self.parameters!r}',price={self.cost!r})"

class NewOfferReference:
    def __init__(self, apikey_id: uuid.UUID, time: datetime, skill_id: uuid.UUID, post_id: uuid.UUID, description: str, tags: list[str], cost: float, url: str):
        self.apikey_id = apikey_id
        self.skill_id = skill_id
        self.post_id = post_id
        self.description = description
    ...
    def __repr__(self):
        return f"OfferReference(apikey_id='{self.apikey_id!r}', skill_id='{self.skill_id!r}', post_id='{self.post_id!r}', description='{self.description!r}', tags='{self.tags!r}', cost='{self.cost!r}', url='{self.url!r}')"

class OfferReference(NewOfferReference):
    def __init__(self, id: uuid.UUID, time: datetime, apikey_id: uuid.UUID, skill_id: uuid.UUID, post_id: uuid.UUID, description: str, tags: list[str], cost: float, url: str):
        super().__init__(apikey_id, skill_id, post_id, description, tags, cost, url)
        self.id = id
        self.time = time
    ...
    def __repr__(self):
        return f"OfferReference(id='{self.id!r}', time='{self.time!r}', apikey_id='{self.apikey_id!r}', skill_id='{self.skill_id!r}', post_id='{self.post_id!r}', description='{self.description!r}', tags='{self.tags!r}', cost='{self.cost!r}', url='{self.url!r}')"
    
    def get_assistant_info(self):
        return f"OfferReference(description='{self.description!r}',tags='{self.tags!r}',price={self.cost!r},url='{self.url!r}')"
...
class BidResponse():
    def __init__(self, action_id: uuid.UUID, post_id: uuid.UUID, cost: float | None, url_remote: str | None):
        self.action_id = action_id
        self.post_id = post_id
        self.cost = cost
    ...
    def from_dict(cls, data: dict):
        return cls(
            ...
            url_remote=data["url_remote"] if data.get("url_remote") is not None else None
        )
    ...
    def to_dict(self):
        return {
            ...
            "url_remote": self.url_remote
        }
    
    def __str__(self):
        return f"Action ID: {self.action_id}\nPost ID: {self.post_id}\nCost: {self.cost}\nURL Remote: {self.url_remote}"
    
    def __repr__(self):
        return f"BidResponse(action_id='{self.action_id!r}', post_id='{self.post_id!r}', cost='{self.cost!r}', url_remote='{self.url_remote!r}')"
...
class EmailVerif():
    ...
    def __repr__(self):
        return f"EmailVerif(token='{self.token!r}', params='{self.params!r}')"
...
class SessionToken():
    ...
    def __repr__(self):
        return f"SessionToken(token='{self.token!r}')"
